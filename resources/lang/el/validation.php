...
return [
    ...
    */
    ...
    'confirmed'            => 'Τα πεδίο δεν ταιριάζει με την επιβεβαίωση κωδικού.',
    ...
    'not_in'               => 'Το επιλεγμένο πεδίο δεν είναι αποδεκτό.',
    ...
    'unique'               => 'Το πεδίο :attribute υπάρχει ήδη στην λίστα.',
