            ...
            @endif
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <br>
                        <div>
                            <div><a href="{{ route('user.profile.edit.password', $user->id) }}" class ="btn btn-info">Αλλαγή κωδικού πρόσβασης</a></div>
                            <br>

                            <div><a href="{{ route('user.profile.edit', $user->id) }}" class ="btn btn-warning">Επεξεργασία λογαριασμού</a></div>
                            <br>

                            @if(Auth::user()->id != 1)
                                <div><a class="btn btn-danger" class="modal-pointer-default" data-toggle="modal" data-target="#exampleModal2">Διαγραφή λογαριασμού</a></div>
                            @endif
                            <br>
