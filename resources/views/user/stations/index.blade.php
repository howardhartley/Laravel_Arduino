...
@section('content')
    ...
    <div class="row text-center">
        ...
        <div class="col-sm-12">
            ...
            <h3>Προβολή όλων των σταθμών μου</h3>
            <hr><br>
                ...
                <div class="wow fadeIn"  data-wow-duration="1.2s" data-wow-delay="1.3s" style="overflow-x:auto;">
                    <table class="table table-striped table-responsive">
                        ...
                        @foreach($stations as $station)
                            ...
                            <tr>
                                <td><a title="κάνε κλικ για επεξεργασία" href=" {{ route('user.stations.edit', $station->id) }} ">{{ $station->name }}</a> </td>
                                ...
                                <td>
                                        ...
                                        {!! Form::open(['method' => 'DELETE', 'action' => ['UserStationsController@destroy', $station->id]]) !!}
